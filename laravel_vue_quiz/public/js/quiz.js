...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    // $route.queryでQueryStringを取得。型はObject
    var categories = this.$route.query.categories; // this.$httpはAxiosを使ったAPIの処理
    // apiのrouteにアクセスし取得したデータをthis.quizDataに代入する
  ...
  methods: {
    ...
    goNextQuiz: function goNextQuiz() {
      ...
      if (this.quizNumber >= 10) {
        ...
        // 次のクイズを表示し、クイズ番号を加算する。laert-info, alert-danger、解説を非表示にする
...
module.exports = __webpack_require__(/*! /Users/ishikawafumiya/Desktop/work/quizapp_tutrial/quizapp_tutrial/laravel_vue_quiz/resources/js/quiz.js */"./resources/js/quiz.js");
